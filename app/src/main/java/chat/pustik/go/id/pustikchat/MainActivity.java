...
import chat.pustik.go.id.pustikchat.Adapter.ChatRoomsAdapter;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ChatRoomsAdapter(Helper.getChatList(), new ChatRoomsAdapter.OnClick() {
            @Override
            public void onClick(ChatModel model) {
                startActivity(new Intent(MainActivity.this, DetailMessageActivity.class));
            }
        });
